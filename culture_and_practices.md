...
The same applies to software products. It’s possible to develop software that works (just like an ugly meal would still feed you) but if you want to build great design write great software there are some practices that will set you up for success. These practices are often referred to as discipline.
...
- If you feel that you’re technically blocked for more than one hour, ask for help. Please check the Team Profiles page to find who can help you best. If you still don’t know who to ask for help, ask your project’s TL;
- If you need help on a task feel free to schedule a pairing session with anyone on the team. Remember to look at their calendar for availability. Send a heads-up on Slack after scheduling;
