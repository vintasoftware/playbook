...
- Code is the main source of truth, so it's important to maintain is easy to read and understand. If you can’t avoid your code being complex, use comments. 
...
- You can have more unit tests than integration ones but always make sure you have integration tests in place. They're more stable and tend to stay valid on refactoring [see Test Pyramid];
...
TDB - needs improvement - https://vinta.atlassian.net/wiki/spaces/development/pages/1870757891/Version+Control+and+Git+Flow
...
Code Review is an integrated software development process that helps identify bugs and defects before the testing phase. This is often overlooked as an ongoing practice during the development phase, but countless studies show it's the most effective quality assurance strategy.
